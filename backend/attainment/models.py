...
class facultyuser(AbstractUser):
    ...
    def get_full_name(self):
        return self.name or super().get_full_name() or self.username
...
class Faculty(models.Model):
    # Legacy model kept for backwards-compat with existing migrations.
...
class CO(models.Model):
    ...
    co_number = models.CharField(max_length=10, null=True, blank=True)
    description = models.TextField()
...
class COPOMapping(models.Model):
    ...
    mapping_level = models.IntegerField(null=True, blank=True)
